...
public static String[][] getDataPieces() {
	String[][] datasPieces = {
			 {"piece1", "piece2", "piece3","piece4","piece5","piece6","piece7","piece8","piece9"},
			 {"Electricity", "Composites", "Sheet metal", "Tubing","Door", "Wheels"},
			 {"152 000", "14 300", "99 000","9494 925","845 694","84 843","518 793","45 475","77 469"},
	};
...
public static HashMap<Integer ,String[]> dataPieces(){
